...
def check_input_files():
    ...
    if missing_files:
        ...
        print("请确保以下文件存在:")
        print("- logs.xlsx: DNS日志文件")
        print("- label.csv: 异常IP标签文件")
        return False
...
def create_sample_data():
    ...
    if not Path('label.csv').exists():
        ...
        label_df.to_csv('label.csv', index=False, encoding='utf-8')
...
def main():
    ...
    print("\n🔧 系统维护:")
    print("- 更新DNS日志: 替换 log.xlsx 并重新运行步骤1-3")
